export default class CountdownTimer {
    ...
    timerMarkup() {
      return `
      <div className="timer">
        <span class="timer-days value">${this.getDays()}:</span> 
        <span class="timer-hours value">${this.getHours()}:</span> 
        <span class="timer-minutes value">${this.getMinutes()}:</span> 
        <span class="timer-seconds value">${this.getSeconds()}</span>
      </div>
      `;
    }
